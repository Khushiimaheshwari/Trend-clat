      ...
      <div className="relative z-0 mt-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-slate-800 rounded-lg shadow-md p-6 border border-slate-700">
            <h2 className="text-xl font-semibold text-white mb-6">Customer Demographics</h2>
            ...
            <div className="grid grid-cols-2 gap-2 mt-4">
              <div className="flex items-center">
                ...
                <span className="text-xs text-gray-300">New Users (45%)</span>
              </div>
              <div className="flex items-center">
                <div className="w-3 h-3 bg-green-500 rounded-full mr-2"></div>
                <span className="text-xs text-gray-300">Returning (25%)</span>
              </div>
              <div className="flex items-center">
                <div className="w-3 h-3 bg-yellow-500 rounded-full mr-2"></div>
                <span className="text-xs text-gray-300">Premium (15%)</span>
              </div>
              <div className="flex items-center">
                <div className="w-3 h-3 bg-purple-500 rounded-full mr-2"></div>
                <span className="text-xs text-gray-300">Wholesale (10%)</span>
              </div>
              <div className="flex items-center">
                <div className="w-3 h-3 bg-rose-500 rounded-full mr-2"></div>
                <span className="text-xs text-gray-300">International (5%)</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-800 rounded-lg shadow-md p-6 border border-slate-700">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link to="/users" className="inline-flex items-center text-teal-300 font-medium hover:text-teal-200 hover:scale-105 transition-all duration-300">
              View All Users <ChevronRight size={16} className="ml-1" />
            </Link>
          </div>
          ...
          <div className="flex space-x-4 mb-6">
            <div className="flex-1 bg-slate-700 rounded-lg p-4">
              ...
              <div className="text-3xl font-bold text-white mb-2">4,287</div>
            ...
            <div className="flex-1 bg-slate-700 rounded-lg p-4">
              ...
              <div className="text-3xl font-bold text-white mb-2">₹753.25</div>
          ...
          <div className="pl-4 border-l border-slate-700">
            <div className="mb-4 relative">
              ...
              <p className="text-xs text-gray-400">User Sarah Johnson completed registration</p>
            </div>
            <div className="mb-4 relative">
              <div className="absolute -left-6 mt-1 w-3 h-3 rounded-full bg-green-500"></div>
              <div className="flex justify-between mb-1">
                <h4 className="text-sm font-medium text-white">Order #ORD-5983 placed</h4>
                <span className="text-xs text-gray-400">42 minutes ago</span>
              </div>
              <p className="text-xs text-gray-400">Customer purchased 3 items totaling ₹1,259.99</p>
            </div>
            <div className="mb-4 relative">
              <div className="absolute -left-6 mt-1 w-3 h-3 rounded-full bg-yellow-500"></div>
              <div className="flex justify-between mb-1">
                <h4 className="text-sm font-medium text-white">Product stock alert</h4>
                <span className="text-xs text-gray-400">1 hour ago</span>
              </div>
              <p className="text-xs text-gray-400">DC Comics Acid Wash T-Shirts running low (64 remaining)</p>
            </div>
            <div className="mb-4 relative">
              <div className="absolute -left-6 mt-1 w-3 h-3 rounded-full bg-purple-500"></div>
              <div className="flex justify-between mb-1">
                <h4 className="text-sm font-medium text-white">New product review</h4>
                <span className="text-xs text-gray-400">3 hours ago</span>
              </div>
              <p className="text-xs text-gray-400">Customer left a 5-star review for "Marvel Universe Oversized T-Shirts"</p>
            </div>
          </div>
        </div>
      </div>
